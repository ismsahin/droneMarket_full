...
const kaydol = () => {
    return (
        <div class="relative flex flex-col text-gray-700 bg-transparent shadow-none rounded-xl bg-clip-border place-items-center my-10 bg-gray-300">
            ...
            <form class="max-w-screen-lg mt-8 mb-2 w-80 sm:w-96">
                ...
                <p class="block mt-4 font-sans text-base antialiased font-normal leading-relaxed text-center text-gray-700">
                    ...
                    <a href="/girisyap" class="font-medium text-gray-900">
                        Giriş yap
                    </a>
                </p>
            </form>
